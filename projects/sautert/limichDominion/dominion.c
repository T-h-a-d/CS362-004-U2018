...
int outpost_effect(struct gameState *state, int currentPlayer, int handPos){			
      //discard card
      discardCard(handPos, currentPlayer, state, 0);
      return 0;
}

int ambassador_effect(int choice1, int choice2, struct gameState *state, int currentPlayer, int handPos){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurer_effect(state, currentPlayer);      
      return 0;
			
    case council_room:
      council_room_effect(state, currentPlayer, handPos);		
      return 0;
    ...
    case ambassador:
      ambassador_effect(choice1, choice2, state, currentPlayer, handPos);
      return 0;
    ...
    case outpost:
      outpost_effect(state, currentPlayer, handPos);
      return 0;
